          ...
          <div className="flex-shrink-0 pt-6 mt-auto border-t" style={{ borderColor: isDarkMode ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.1)' }}>
            ...
            <div className="mb-4 px-2">
              <button
                ...
                className="group relative w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl font-medium transition-all duration-300 hover:scale-105 overflow-hidden text-sm"
                style={{ 

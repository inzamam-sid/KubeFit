...
//                 <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-orange-600 rounded-full blur-lg opacity-75 group-hover:opacity-100 transition-opacity" />
//                 <div className="relative w-10 h-10 rounded-full bg-gradient-to-r from-red-600 to-orange-600 flex items-center justify-center">
//                   <span className="text-xl">💪</span>
//                 </div>
//               </div>
//               <div>
//                 <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 bg-clip-text text-transparent">
//                   KubeFit
//                 </h1>
//                 <p className="text-[8px] sm:text-[10px] text-gray-500 -mt-1">POWERED BY ScaleDevX</p>
//               </div>
//             </div>
...
//                   {isActive(item.path) && (
//                     <div className="absolute inset-0 rounded-lg" style={{ background: gradients.brand, opacity: 0.1 }} />
//                   )}
                  
//                   {!isActive(item.path) && (
//                     <div className="absolute inset-0 -translate-x-full group-hover:translate-x-0 transition-transform duration-500 rounded-lg bg-gradient-to-r from-red-600/10 to-orange-600/10" />
//                   )}
                  
//                   {isActive(item.path) && (
//                     <div className="absolute bottom-0 left-0 right-0 h-0.5 rounded-full mx-auto w-8" style={{ background: gradients.brand }} />
//                   )}
//                 </button>
//               ))}
//             </div>
...
//                 className="group relative overflow-hidden px-6 py-2 rounded-lg font-semibold text-white transition-all duration-300 hover:scale-105"
...
//               className="md:hidden p-2 rounded-lg transition-all duration-300 hover:bg-gray-800"
//             >
//               <svg
...
//       <div
//         className={`fixed top-[72px] left-0 right-0 z-40 md:hidden transition-all duration-500 overflow-hidden ${
//           isMobileMenuOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"
//         }`}
//         style={{ background: 'rgba(28, 28, 30, 0.98)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(255,255,255,0.1)' }}
//       >
...
//               }`}
//               style={isActive(item.path) ? { background: 'rgba(255, 59, 48, 0.1)' } : {}}
//             >
//               <span className="text-xl">{item.icon}</span>
//               <span className="font-medium">{item.name}</span>
//               {isActive(item.path) && (
//                 <div className="ml-auto w-1.5 h-1.5 rounded-full bg-gradient-to-r from-red-500 to-orange-500 animate-pulse" />
//               )}
//             </button>
//           ))}
...
//                 setIsMobileMenuOpen(false);
//               }}
//               className="w-full group relative overflow-hidden px-4 py-3 rounded-lg font-semibold text-white transition-all duration-300"
